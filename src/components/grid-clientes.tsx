...
interface CellRendererParams extends ICellRendererParams {
  data: ClienteType;
  onEdit: (registro: ClienteType) => void;
}

type Props = {
  data: ClienteType;
  onEdit: (registro: ClienteType) => void;
  onDelete: (registro: ClienteType) => void;
  node?: IRowNode;
};

type GridProps = {
  registros: ClienteType[];    
  aoEditar: (registro: ClienteType) => void;
  antesDeDeletar: (registro: ClienteType) => void;
};
