...
interface CellRendererParams extends ICellRendererParams {
  data: ContaReceberType;
  onEdit: (registro: ContaReceberType) => void;
}

type Props = {
  data: ContaReceberType;
  onEdit: (registro: ContaReceberType) => void;
  onDelete: (registro: ContaReceberType) => void;
  node?: IRowNode;
};

type GridProps = {
  registros: ContaReceberType[];    
  aoEditar: (registro: ContaReceberType) => void;
  antesDeDeletar: (registro: ContaReceberType) => void;
};
