...
interface CellRendererParams extends ICellRendererParams {
  data: CategoriaType;
  onEdit: (registro: CategoriaType) => void;
}

type Props = {
  data: CategoriaType;
  onEdit: (registro: CategoriaType) => void;
  onDelete: (registro: CategoriaType) => void;
  node?: IRowNode;
};

type GridProps = {
  registros: CategoriaType[];    
  aoEditar: (registro: CategoriaType) => void;
  antesDeDeletar: (registro: CategoriaType) => void;
};
