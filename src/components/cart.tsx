...
import { CreditCard, QrCode, Banknote, Edit2, ChevronsRight, ChevronsLeft } from "lucide-react"
...
export function Cart() {
  ...
  return (
    <div className={`bg-white border-l flex flex-col h-full transition-all duration-300 ${minimized ? 'w-16' : 'w-[380px]'}`}>
      ...
      {/* Conteúdo do carrinho (oculto quando minimizado) */}
      {!minimized && (
        <>
