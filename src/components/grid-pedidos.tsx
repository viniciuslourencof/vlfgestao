...
interface CellRendererParams extends ICellRendererParams {
  data: PedidoType;
  onEdit: (registro: PedidoType) => void;
}

type Props = {
  data: PedidoType;
  onEdit: (registro: PedidoType) => void;
  onDelete: (registro: PedidoType) => void;
  node?: IRowNode;
};

type GridProps = {
  registros: PedidoType[];    
  aoEditar: (registro: PedidoType) => void;
  antesDeDeletar: (registro: PedidoType) => void;
};
